...
AES::AES(unsigned char* key) {
	GenerateRoundKey(key, rKey);
	// GenerateSBox(SBox, InvSBox);
	SBox = {
...
// ---------- SubBytes ---------- //
void AES::GenerateSBox(unsigned char SBox[], unsigned char InvSBox[]) {
	/* Not implemented */
}
...
// ---------- MixColumns ---------- //
unsigned char AES::Multiplication(unsigned char a, unsigned char b) {
	unsigned char r = 0;
	/* Not implemented */
	return r;
}
...
// ---------- AddRoundKey ---------- //
void AES::GenerateRoundKey(unsigned char *key, unsigned char rKey[][4][4]) {
	/* Not implemented */
}
